    ...
    <main className="flex flex-col min-h-screen py-16">
      <section className="bg-gradient-to-b from-purple-50 to-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-purple-800 mb-6">데뷰인</h1>
          <p className="text-lg mb-10 max-w-2xl mx-auto text-purple-600">
          ...
          <div className="mt-16">
                ...
                <div key={champion.id} className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-500">
                  <div className="p-6">
                    <div className="flex items-center justify-center mb-4">
                      <div className="w-16 h-16 rounded-full bg-purple-50 flex items-center justify-center text-purple-700">
                        <champion.icon className="w-8 h-8" />
                      </div>
                    </div>
                    <div className="text-center mb-4">
                      <div className="inline-block px-3 py-1 bg-purple-100 text-purple-700 text-sm font-medium rounded-full mb-2">
                        {champion.grade}
                      </div>
            ...
            <div className="mt-16 text-center">
              ...
              <Link 
                ...
                className="inline-flex items-center bg-purple-700 text-white px-6 py-3 rounded-lg hover:bg-purple-800 transition-colors shadow-md"
              >
